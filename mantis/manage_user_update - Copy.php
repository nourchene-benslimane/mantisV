	...
	if ( $f_protected && $t_old_protected ) {
	    ...
	    $query = "UPDATE $t_user_table
	    		SET username=" . db_param() . ", email=" . db_param() . ",
	    			...
	    			protected=" . db_param() . ", realname=" . db_param() . /*", role=" . db_param() . "*/"
	    		WHERE id=" . db_param();
	    $query_params = Array( $c_username, $c_email, $c_access_level, $c_enabled, $c_protected, $c_realname, $c_user_id/*, $c_role*/);
	}
