...
# along with MantisBT.  If not, see <http://www.gnu.org/licenses/>.
	...
	#added
	$g_default_new_account_role = PROJECT_MEMBER;
	##added
	$g_default_new_account_agency = AGENCE_PRINCIPALE;
	##added
	$g_default_new_account_unit_department = 0;
	...
	#modification effectuée le 10/08/2012 pour ajouter une enumeration $g_user_roles_enum_string##
	##############################################################################################
	/**
	 * 
	 * @global string $g_user_roles_enum_string
	 */
	$g_user_roles_enum_string		= '10:project member,20:staff';
	##############################################################################################
	##end##
	
	#modification effectuée le 15/08/2012 pour ajouter une enumeration $g_btl_agencies_enum_string##
	##############################################################################################
	/**
	 * 
	 * @global string $g_btl_agencies_enum_string
	 */
	$g_btl_agencies_enum_string		= '10:agence principale ,20:agence ben arous,30:agence la petite ariana,40:agence nabeul, 50:agence sfax';
	##############################################################################################
	##end##
	
	#modification effectuée le 16/08/2012 pour ajouter une enumeration $g_btl_units_departments_enum_string##
	##############################################################################################
	/**
	 * 
	 * @global string $g_btl_units_departments_enum_string
	 */
	$g_btl_units_departments_enum_string		= '10:unité contrôle des risques,20:unité audit interne,30:unité compliance,40:direction centrale des affaires administratives et organisation,50:direction centrale de l\'international,60:direction centrale des crédits,70:direction centrale de l\'exploitation,80:direction centrale de la comptabilité et du contrôle de gestion,90:direction des systèmes d\'information,100:direction centrale des engagements et des opérations';
	##############################################################################################
	##end##
