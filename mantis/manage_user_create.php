...
#added###################################################################
	$f_role			   = gpc_get_string('role');
	$f_agency		   = gpc_get_string('agency');
	$f_unit_department = gpc_get_string('unit_department');
...
<div align="center">
<?php
$t_role = get_enum_element( 'user_roles', $f_role );
$t_agency = get_enum_element( 'btl_agencies', $f_agency );
$t_unit_department = get_enum_element('btl_units_departments', $f_unit_department);
	$t_access_level = get_enum_element( 'access_levels', $f_access_level );
	echo lang_get( 'created_user_part1' ) . ' <span class="bold">' . $f_username . '</span> ' . lang_get( 'created_user_part2' ) . ' <span class="bold">' . $t_username . '</span><br />';
