...
function html_bottom_banner() {
	...
	if( !is_blank( $t_page ) && file_exists( $t_page ) && !is_dir( $t_page ) ) {
		include( $t_page );
		#modifié le 08/08/2012
		echo '<a href="http://www.mantisbt.org" title="Free Web Based Bug Tracker"><img src="' . helper_mantis_url( 'images/mantis_logo_.png' ) . '" width="145" height="50" alt="Powered by Mantis Bugtracker" border="0" /></a>';
	}
}
...
function html_footer( $p_file = null ) {
	...
	echo '</td><td>', "\n\t";
#modification du 2eme echo effectuée le 07/08/2012
