...
function user_create( $p_username, $p_password, $p_email = '',
	...
	$p_realname = '', $p_admin_name = '', /*added*/$p_role=null, /*added*/ $p_agency=null, /*added*/ $p_unit_department=null ) {
...
##ajouté## le 15/08/2012##
# --------------------
# return the user's role
function user_get_role( $p_user_id ) {
	$t_role = user_get_field( $p_user_id, 'role' );
