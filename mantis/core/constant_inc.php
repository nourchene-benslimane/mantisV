...
##############################################################################################
# user roles
define ('PROJECT_MEMBER',10);
define ('STAFF',20);
#############################################################################################
## end ##

#modification effectuée le 15/08/2012##
##############################################################################################
# btl agencies
define ('AGENCE_PRINCIPALE',10);
define ('AGENCE_BEN_AROUS',20);
define ('AGENCE_LA_PETITE_ARIANA',30);
define ('AGENCE_NABEUL',40);
define ('AGENCE_SFAX',50);
#############################################################################################
## end ##

#modification effectuée le 16/08/2012##
##############################################################################################
# btl unit/departments
define ('UNITE_CONTROLE_DES_RISQUES',10);
define ('UNITE_AUDIT_INTERNE',20);
define ('UNITE_COMPLIANCE',30);
define ('DIRECTION_CENTRALE_DES_AFFAIRES_ADMINISTRATIVES_ET_ORGANISATION',40);
define ('DIRECTION_CENTRALE_DE_L_INTERNATIONAL',50);
define ('DIRECTION_CENTRALE_DES_CREDITS',60);
define ('DIRECTION_CENTRALE_DE_L_EXPLOITATION',70);
define ('DIRECTION_CENTRALE_DE_LA_COMPTABILITE_ET_DU_CONTROLE_DE_GESTION',80);
define ('DIRECTION_CENTRALE_DES_SYSTEMES_D_INFORMATION',90);
define ('DIRECTION_CENTRALE_DES_ENGAGEMENTS_ET_DES_OPERATIONS',100);
#############################################################################################
## end ##
