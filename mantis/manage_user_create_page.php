...
<tr <?php echo helper_alternate_class() ?>>
	...
	<td>
		<select name="access_level">
			<?php print_enum_string_option_list( 'access_levels'  ) ?>
		</select>
	</td>
</tr>
...
<tr <?php echo helper_alternate_class() ?>>
	...
	<td>
		<select name="role">
			<?php print_enum_string_option_list ('user_roles') ?>
...
<tr <?php echo helper_alternate_class() ?>>
	...
	<td>
		<select name="agency">
			<?php print_enum_string_option_list('btl_agencies') ?>
		</select>
	</td>
</tr>
...
<tr <?php echo helper_alternate_class() ?>>
	...
	<td>
		<select name="unit_department">
			<?php print_enum_string_option_list('btl_units_departments') ?>
		</select>
	</td>
</tr>
