...
<tr <?php echo helper_alternate_class() ?>>
	<td class="category">
		<?php echo lang_get( 'role' ) ?>
	</td>
	<td>
		<select name="role">
		<?php print_enum_string_option_list( 'user_roles', $t_user['role'] ) ?>
		</select>
	</td>
</tr>
<!-- Agency -->
<tr <?php echo helper_alternate_class() ?>>
	<td class="category">
		<?php echo lang_get( 'agency' ) ?>
	</td>
	<td>
		<select name="agency">
		<?php print_enum_string_option_list( 'btl_agencies', $t_user['agency'] ) ?>
		</select>
	</td>
</tr>
...
<tr <?php echo helper_alternate_class() ?>>
	<td class="category">
		<?php echo lang_get( 'unit_department' ) ?>
	</td>
	<td>
		<select name="unit_department">
		<?php print_enum_string_option_list( 'btl_units_departments', $t_user['unit_department'] ) ?>
		</select>
	</td>
</tr>
